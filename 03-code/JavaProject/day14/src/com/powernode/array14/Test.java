        ...
        do {
            ...
            switch (num) {
                case 1 -> {
                    ...
                    studentManager.insert(getStudent());
                    studentManager.queryAll();
                }
                case 2 -> {
                    System.out.println("----------执行删除操作------------");
                    studentManager.deleteStudentBySNO(getSNO());
                    studentManager.queryAll();
                }
                case 3 -> {
                    System.out.println("----------执行修改操作------------");
                    studentManager.updateStudentBySNO(getSNO(),getStudent());
                    studentManager.queryAll();
                }
                case 4 -> {
