...
public class Test02 {
    public static void main(String[] args) {
        ...
        integers1.add(2);
        integers1.add(3);
        System.out.println("integers1.hashCode() = " + integers1.hashCode());
        //通过集合拿到一个迭代器，用于遍历集合中元素
        ...
        System.out.println(iterator.next());//java.util.NoSuchElementException,迭代器到底了，没有元素可取
    }
}
